...
/**
 * A placeholder for your mock data. In a real application, this would
 * likely be imported from '@/api/mockData.js'.
 */
...
const initialMockAllQuestions = [
  // A small subset of questions for the standard assessment
  {
    id: 1,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        recommendation: 'Very Poor. No logging exists. Implement centralized logging immediately.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        score: 0,
        explanation: 'Infrequent scanning provides a poor and outdated picture of the actual risk.',
        recommendation:
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        score: -2,
        explanation: 'Lack of awareness of a common and impactful threat is a major business risk.',
        recommendation:
    ...
    options: [
      {
        ...
        recommendation: 'Excellent. This mature plan ensures business continuity during disasters.',
      },
      {
      ...
      },
      {
        ...
        recommendation: 'Poor. Backup location creates risk. Store backups in a different region.',
      },
      {
      ...
      },
      {
        ...
        score: -2,
        explanation: 'A major business risk that threatens the continuity of the entire operation.',
        recommendation:
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        recommendation: 'Good. Alerting exists but implement 24/7 monitoring for faster response.',
      },
      {
    ...
    options: [
      {
        ...
        score: 2,
        explanation: 'Excellent. Correctly implemented where required, showing mature governance.',
        recommendation:
      ...
      },
      {
        ...
        score: -2,
        explanation: "Indicates a significant gap in understanding GDPR's governance requirements.",
        recommendation:
    ...
    options: [
      {
        ...
        recommendation: 'Regularly test your breach reporting process through tabletop exercises.',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        score: -2,
        explanation: 'A direct breach of a mandatory GDPR documentation requirement (Article 30).',
        recommendation:
...
export const useQuestionnairesStore = defineStore('questionnaires', () => {
  ...
  const duplicateQuestionnaire = (questionnaireId) => {
    const original = getQuestionnaireById(questionnaireId)
    if (!original) {
    ...
    const existingNames = new Set(questionnaires.value.map((q) => q.name))
    ...
    allQuestions.value.push(...newQuestions)
    return { success: true, newQuestionnaire }
  }
